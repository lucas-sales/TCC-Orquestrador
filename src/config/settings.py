...
QUEUE_MIGRATION_ROUTING_KEY = os.environ.get('QUEUE_MIGRATION_ROUTING_KEY')
...
QUEUE_MIGRATION_RESPONSE_ROUTING_KEY = os.environ.get('QUEUE_MIGRATION_RESPONSE_ROUTING_KEY')
...
def load():
    ...
    required_env_vars = [
        ...
        'QUEUE_MIGRATION_ROUTING_KEY',
        'QUEUE_MIGRATION_RESPONSE_ROUTING_KEY',
    ]
